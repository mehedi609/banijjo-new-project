...
const privacyPolicy = () => {
    ...
    return (
        <BaseLayout>
           ...
           <br></br>Data protection is a matter of trust and your privacy
           is important to us. We shall therefore only use your name and
           ...
           for which it was collected.<br></br>
           ...
           place an order for a product with us on the Site.<br></br>We collect, store and process your data for
           processing your purchase on the Site and any possible later
           claims, and to provide you with our services. We may collect
           personal information including, but not limited to, your
           title, name, gender, date of birth, email address, postal
           address, delivery address (if different), telephone number,
           mobile number, fax number, payment details, payment card
           details or bank account details.
        </p>
                        <h1 class="h5 text-left">Other uses of your Personal Information</h1>
                        <p class="text-justify">
