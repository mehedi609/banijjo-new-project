...
import { calDiscountPercentage, capitalizeStr, shorten_the_name } from "utils/utils";
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-6 col-lg-3">
            ...
            <select className="custom-select mt-2" defaultValue={selectedCatVal} onChange={onChangeCatHandler} aria-labelledby="lbl-select-category">
            ...
            {!item.seeMore && (
              <div className="row">
                <div className="offset-md-5 col-md-2 text-center">
                  <button type="submit" className="btn-sm btn-success btn-color rounded-0  mt-2 mb-2" onClick={onClickHandler(item.categoryId)} aria-label="See More Button">See More</button>
                </div>
              </div>
            )}
        </Fragment>
