                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-9">
                            ...
                            { cartProducts.length > 0 && cartProducts.map(({ breadcrumbs, products }) => (
                                <Fragment>
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col-md-3">
                                            <img src="https://admin.banijjo.com.bd/upload/product/productImages/2_2240x1680.png" className="img-fluid" />
                                        </div>
                                        <div className="col-md-4">
                                        ...
                                        <div className="col-md-4">
                                            <div className="quantity">
                                                <div className="quantity-select">
                                                    <div className="entry value-minus1">
                                                        &nbsp;
                                                    </div>
                                                    <div className="entry value1">
                                                        <span>10</span>
                                                    </div>
                                                    <div className="entry value-plus1 active">
                                                        &nbsp;
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="card-footer">
                                    <div className="text-right">
                                        <p className="my-0"> Total price:
                                            <b>
                                                <em>৳&nbsp;</em> 1200
                                            </b>
                                        </p>
                                        <button style={{ display: 'none' }} id="LoginRegisterModalButton"
                                            type="button" data-toggle="modal" data-target="#LoginRegisterModal"></button>
                                        <button style={{ display: 'none' }} id="ShippingModalButton" type="button" data-toggle="modal"
                                            data-target="#ShippingModal"></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                            <div className="panel panel-default">
                                ...
                                <div className="panel-body">
                                    ...
                                    <div className="col-md-12">
                                        <strong className="strong-left-vat">
                                            VAT & Tax
                                        </strong>
                                        <div className="float-right">
                                            <span>
                                    ...
                                    <div className="col-md-12">
                                        <strong className="strong-left-discount">
                                            Discount
                                        </strong>
                                        <div className="float-right">
                                            <span>
                                    ...
                                    <div className="col-md-12">
                                        <strong>
                                            Promo Code
                                            <span style={{ cursor: 'pointer' }} className="badge badge-success btn-apply rounded">
                                                Apply
                                            </span>
                                        </strong>
                                        <div className="float-right">
                                    ...
                                    <div className="col-md-12">
                                        <strong className="strong-left-order">
                                            Order Total
                                        </strong>
                                        <div className="float-right">
                                            <span>
                                    ...
                                    <button className="btn btn-primary btn-continue-shop" id="PromoCodeModalButton" type="button"
                                        data-toggle="modal" data-target="#PromoCodeModal">
                                        Continue shopping
                                    </button>
                                </div>
                            </div>
