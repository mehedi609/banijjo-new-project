        ...
        return (
            <BaseLayout>
                <Head>
                    ...
                    <meta name="description" content="page where user finalizes the purchasea" />
                        ...
                        <form action="#">
                            <div className="row">
                                <div className="col-lg-8 col-md-6">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6">
                                            <div className="checkout-input mb-3">
                                                <p className="mb-3">Fist Name<span>*</span></p>
                                                <input type="text" />
                                            </div>
                                        </div>
                                        <div className="col-lg-6">
                                            <div className="checkout-input mb-3">
                                                <p className="mb-3">Last Name<span>*</span></p>
                                                <input type="text" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="checkout-input mb-3">
                                        <p className="mb-3">Country<span>*</span></p>
                                        <input type="text" />
                                    </div>

                                    <div className="checkout-input mb-3">
                                        <p className="mb-3">Address<span>*</span></p>
                                        <input type="text" placeholder="Street Address" className="checkout-input-add mb-3" />
                                        <input type="text" placeholder="Apartment, suite, unite ect (optinal)" />
                                    </div>

                                    <div className="checkout-input mb-3">
                                        <p className="mb-3">Town/City<span>*</span></p>
                                        <input type="text" />
                                    </div>

                                    <div className="checkout-input mb-3">
                                        <p className="mb-3">Country/State<span>*</span></p>
                                        <input type="text" />
                                    </div>

                                    <div className="checkout-input mb-3">
                                        <p className="mb-3">Postcode / ZIP<span>*</span></p>
                                        <input type="text" />
                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6">
                                            <div className="checkout-input mb-3">
                                                <p className="mb-3">Phone<span>*</span></p>
                                                <input type="text" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-6">
                                            <div className="checkout-input mb-3">
                                                <p className="mb-3">Email<span>*</span></p>
                                                <input type="text" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="checkout-input mb-3">
                                        <p className="mb-3">Account Password<span>*</span></p>
                                        <input type="text" />
                                    </div>
                                    ...
                                    <div className="checkout-input mb-3">
                                        <p className="mb-3">Order notes<span>*</span></p>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="checkout-order p-4 pt-3">
                                        ...
                                        <div className="checkout-order-products mb-2">Products <span>Total</span></div>
                                        <ul className="mb-2">
                                            <li>Vegetable’s Package <span>$75.99</span></li>
                                            <li>Fresh Vegetable <span>$151.99</span></li>
                                            <li>Organic Bananas <span>$53.99</span></li>
                                        </ul>
                                        <div className="checkout-order-subtotal pb-3 pt-3 mb-3">Subtotal <span>$750.99</span></div>
                                        <div className="checkout-order-total pb-3 mb-4">Total <span>$750.99</span></div>
                                        <div className="checkout-input-checkbox mb-2">
                                        ...
                                        <button type="submit" className="site-btn pt-2 pb-2 pr-4 pl-4">PLACE ORDER</button>
                                    </div>
                                </div>
                            </div>
                        </form>
