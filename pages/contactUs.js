                        ...
                        <div className="row">
                            <div className="contact-info mt-3">
                                <div className="col-md-12 mb-3">
                                    <div className="contact-info-left float-left pr-3"><i className="fa fa-map-marker"></i></div>
                                    <div className="contact-info-right d-table-cell"><span>164/A Shahjahan Rd, Dhaka 1207</span></div>
                                </div>
                                <div className="col-md-12 mb-3">
                                    <div className="contact-info-left float-left pr-3"><i className="fa fa-envelope-open" style={{ fontSize: "8px" }}></i></div>
                                    <div className="contact-info-right d-table-cell"><span>info@banijjo.com.bd</span></div>
                                </div>
                                <div className="col-md-12 mb-3">
                                    <div className="contact-info-left float-left pr-3"><i className="fa fa-phone-volume"></i></div>
                                    <div className="contact-info-right d-table-cell"><span>09677-222 222</span></div>
                                </div>
                            </div>
                        </div>
                        <div className="my-3">
